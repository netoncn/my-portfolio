...
function mapDocToSettings(snapshot: QueryDocumentSnapshot): PortfolioSettings {
...
export async function initializeDefaultSettings(): Promise<void> {
  try {
    ...
    const defaultSettings: PortfolioSettingsInput = {
      ...
      bio: {
        "en-US":
          "Full Stack Developer creating modern and functional digital experiences.",
        "pt-BR":
          "Desenvolvedor Full Stack criando experiências digitais modernas e funcionais.",
        "es-ES":
          "Desarrollador Full Stack creando experiencias digitales modernas y funcionales.",
      },
      role: {
